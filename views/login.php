<?php if (Auth::check()): ?>
    <div class="card card--centrado">
        ...
        <p>Hola, <strong><?= e(current_user()['nombre']) ?></strong> (<?= e(current_user()['rol']) ?>).</p>
        <p class="texto-secundario">
            Fase 1 en construcción: todavía no existe la lista de tickets.
            Esta pantalla se reemplaza por el dashboard en las próximas fases.
        </p>
        <a class="btn btn--secondary" href="index.php?p=logout">Cerrar sesión</a>
    </div>
<?php else: ?>
